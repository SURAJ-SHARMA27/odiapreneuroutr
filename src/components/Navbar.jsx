...
const Navbar = () => {
  ...
  const options = [
    ...
    { value:"Prof. Ranjan Kumar Pradhan",label:"Prof. Ranjan Kumar Pradhan"},
    {value:"Prof. Sudhansu Sekhar Sahoo",label:"Prof. Sudhansu Sekhar Sahoo"},
    {value:"Dr. Sanatan Panda",label:"Dr. Sanatan Panda"},
    {value:"Dr. Bhagirathi Kandi",label:"Dr. Bhagirathi Kandi"},
    {value:"Ch. Vijayalaxmi",label:"Ch. Vijayalaxmi"},
    ...
    { value: "Lephripara Higher Secondary School, Lephripara", label: "Lephripara Higher Secondary School, Lephripara" },
{value:"Government (SSD) Higher Secondary School, Chudapali", label:"Government (SSD) Higher Secondary School, Chudapali"},
{value:"Government SSD Higher Secondary School,Ramachandrapur", label:"Government SSD Higher Secondary School,Ramachandrapur"},
{value:"Government (SSD) Higher Secondary School, Malpada", label:"Government (SSD) Higher Secondary School, Malpada"},
{value:"Government (SSD) Girl's Higher Secondary School, Krushna Chandra Pur", label:"Government (SSD) Girl's Higher Secondary School, Krushna Chandra Pur"},
{value:"Government (SSD) Higher Secondary School, Mohana", label:"Government (SSD) Higher Secondary School, Mohana"},
{value:"Government SSD Higher Secondary School,Nuagada", label:"Government SSD Higher Secondary School,Nuagada"},
{value:"Government (SSD) Higher Secondary School, Ramagiri", label:"Government (SSD) Higher Secondary School, Ramagiri"},
{value:"Government (SSD) Higher Secondary School,Rayagada", label:"Government (SSD) Higher Secondary School,Rayagada"},
{value:"Government (SSD) Higher Secondary School,Khaliabhata", label:"Government (SSD) Higher Secondary School,Khaliabhata"},
{value:"Government (SSD) Higher Secondary School, Kuruguda", label:"Government (SSD) Higher Secondary School, Kuruguda"},
{value:"Government (SSD) Higher Secondary School, Lanjigarh", label:"Government (SSD) Higher Secondary School, Lanjigarh"},
{value:"Government (SSD) Higher Secondary School, Gopalpur", label:"Government (SSD) Higher Secondary School, Gopalpur"},
{value:"Government SSD Higher Secondary School,Badagam", label:"Government SSD Higher Secondary School,Badagam"},
{value:"Government (SSD) Higher Secondary School, Daringbadi", label:"Government (SSD) Higher Secondary School, Daringbadi"},
{value:"Government SSD Higher Secondary School,Kudutuli", label:"Government SSD Higher Secondary School,Kudutuli"},
{value:"Government SSD Higher Secondary School,Ranapatuli", label:"Government SSD Higher Secondary School,Ranapatuli"},
{value:"Government (SSD) Higher Secondary School, Kotagarh", label:"Government (SSD) Higher Secondary School, Kotagarh"},
{value:"Government SSD Higher Secondary School,Phiringia", label:"Government SSD Higher Secondary School,Phiringia"},
{value:"Government SSD Higher Secondary School,Boida", label:"Government SSD Higher Secondary School,Boida"},
{value:"Government SSD Higher Secondary School,Guma", label:"Government SSD Higher Secondary School,Guma"},
{value:"Government (SSD) Higher Secondary School, Matkambeda", label:"Government (SSD) Higher Secondary School, Matkambeda"},
{value:"Government (SSD) Higher Secondary School, Raidiha", label:"Government (SSD) Higher Secondary School, Raidiha"},
{value:"Government SSD Higher Secondary School,Dasamantapur", label:"Government SSD Higher Secondary School,Dasamantapur"},
{value:"Government (SSD) Higher Secondary School, Baminiput", label:"Government (SSD) Higher Secondary School, Baminiput"},
{value:"Government (SSD) Higher Secondary School, Kotpad", label:"Government (SSD) Higher Secondary School, Kotpad"},
{value:"Government (SSD) Higher Secondary School, Burja", label:"Government (SSD) Higher Secondary School, Burja"},
{value:"Government (SSD) Higher Secondary School, Kumbhariput", label:"Government (SSD) Higher Secondary School, Kumbhariput"},
{value:"Government (SSD) Higher Secondary School, Thuria", label:"Government (SSD) Higher Secondary School, Thuria"},
{value:"Government (SSD) Higher Secondary School, Sunabeda", label:"Government (SSD) Higher Secondary School, Sunabeda"},
{value:"Government (SSD) Higher Secondary School, Govindpally", label:"Government (SSD) Higher Secondary School, Govindpally"},
{value:"Government(SSD) Higher Secondary School, Chitrakonda", label:"Government(SSD) Higher Secondary School, Chitrakonda"},
{value:"Government (SSD) Higher Secondary School, Baladiaguda", label:"Government (SSD) Higher Secondary School, Baladiaguda"},
{value:"Government (SSD) Higher Secondary School, MV-79", label:"Government (SSD) Higher Secondary School, MV-79"},
{value:"Government (SSD) Higher Secondary School, Bankati", label:"Government (SSD) Higher Secondary School, Bankati"},
{value:"Government(SSD) Higher Secondary School, Badhunia", label:"Government(SSD) Higher Secondary School, Badhunia"},
{value:"Government (SSD) Higher Secondary School, Badampahar", label:"Government (SSD) Higher Secondary School, Badampahar"},
{value:"Government (SSD) Higher Secondary School, Rairangpur", label:"Government (SSD) Higher Secondary School, Rairangpur"},
{value:"Government (SSD) Higher Secondary School, Dabugam", label:"Government (SSD) Higher Secondary School, Dabugam"},
{value:"Government (SSD) Higher Secondary School, Belgam", label:"Government (SSD) Higher Secondary School, Belgam"},
{value:"Government (SSD) Higher Secondary School, Karchamal", label:"Government (SSD) Higher Secondary School, Karchamal"},
{value:"Government (SSD) Higher Secondary School, Dhodipani", label:"Government (SSD) Higher Secondary School, Dhodipani"},
{value:"Government (SSD) Higher Secondary School, Nishanhandi", label:"Government (SSD) Higher Secondary School, Nishanhandi"},
{value:"Government (SSD) Higher Secondary School, Papadahandi", label:"Government (SSD) Higher Secondary School, Papadahandi"},
{value:"Government (SSD) Higher Secondary School, Raighar", label:"Government (SSD) Higher Secondary School, Raighar"},
{value:"Government (SSD) Higher Secondary School, Badabharandi", label:"Government (SSD) Higher Secondary School, Badabharandi"},
{value:"Government (SSD) Higher Secondary School, Dharambandh", label:"Government (SSD) Higher Secondary School, Dharambandh"},
{value:"Government (SSD) Girls Higher Secondary School, Chandrapur", label:"Government (SSD) Girls Higher Secondary School, Chandrapur"},
{value:"Government SSD Higher Secondary School,Gudari", label:"Government SSD Higher Secondary School,Gudari"},
{value:"Government (SSD) Higher Secondary School, Siripur", label:"Government (SSD) Higher Secondary School, Siripur"},
{value:"Government SSD Higher Secondary School, Dongasil", label:"Government SSD Higher Secondary School, Dongasil"},
{value:"Government (SSD) Higher Secondary School, Kailashpur", label:"Government (SSD) Higher Secondary School, Kailashpur"},
{value:"Government (SSD) Higher Secondary School, Ambodala", label:"Government (SSD) Higher Secondary School, Ambodala"},
{value:"Government SSD Higher Secondary School,Khilamunda", label:"Government SSD Higher Secondary School,Khilamunda"},
{value:"Government SSD Higher Secondary School,Sandhapathar", label:"Government SSD Higher Secondary School,Sandhapathar"},
{value:"Government (SSD) Higher Secondary School, Ardabahal", label:"Government (SSD) Higher Secondary School, Ardabahal"},
{value:"Government (SSD) Higher Secondary School, Charbhata", label:"Government (SSD) Higher Secondary School, Charbhata"},
{value:"Government (SSD) Higher Secondary School, Balisankara", label:"Government (SSD) Higher Secondary School, Balisankara"},
{value:"Government(SSD) Higher Secondary School, Tudalaga", label:"Government(SSD) Higher Secondary School, Tudalaga"},
{value:"Government SSD Higher Secondary School,Gurundia", label:"Government SSD Higher Secondary School,Gurundia"},
{value:"Government SSD Higher Secondary School,Jamdarh", label:"Government SSD Higher Secondary School,Jamdarh"},
{value:"Government SSD Higher Secondary School,Gopna", label:"Government SSD Higher Secondary School,Gopna"},
{value:"Government (SSD) Higher Secondary School, Chhatenpali", label:"Government (SSD) Higher Secondary School, Chhatenpali"},
...
{value:"Smt. Susmita Sahoo", label:"Smt. Susmita Sahoo"},
{value:"Smt. Prativa Manjari Das", label:"Smt. Prativa Manjari Das"},
{value:"Shri Mitra BhanuKachhap", label:"Shri Mitra BhanuKachhap"},
{value:"Shri AkrurBarik", label:"Shri AkrurBarik"},
{value:"Shri Dhruba Charan Behera", label:"Shri Dhruba Charan Behera"},
{value:"Shri Gendra Kujur", label:"Shri Gendra Kujur"},
{value:"Shri Krushna Chandra Nayak", label:"Shri Krushna Chandra Nayak"},
{value:"Shri Sachidananda Behera", label:"Shri Sachidananda Behera"},
{value:"Smt. Binita Senapati", label:"Smt. Binita Senapati"},
{value:"Shri Pradosh Kumar Nayak", label:"Shri Pradosh Kumar Nayak"},
{value:"Smt. AmitaPattanaik", label:"Smt. AmitaPattanaik"},
{value:"Shri Niranjan Behera", label:"Shri Niranjan Behera"},
{value:"Smt. NibeditaPani", label:"Smt. NibeditaPani"},
{value:"Smt. PuspaMinj", label:"Smt. PuspaMinj"},
{value:"Shri Sushant Kumar Chopdar", label:"Shri Sushant Kumar Chopdar"},
{value:"Shri Pramod Kumar Sarangi", label:"Shri Pramod Kumar Sarangi"},
{value:"Smt. SubhalaxmiNayak, ADEO I/C", label:"Smt. SubhalaxmiNayak, ADEO I/C"},
{value:"Smt Gouri Rani Naik", label:"Smt Gouri Rani Naik"},
{value:"Shri BiswanathTarai", label:"Shri BiswanathTarai"},
{value:"Shri Rama Chandra Nahak", label:"Shri Rama Chandra Nahak"},
{value:"Shri Manas Kumar Jena", label:"Shri Manas Kumar Jena"},
{value:"Shri Purna Ch. Sethy", label:"Shri Purna Ch. Sethy"},
{value:"Shri Pradeep Kumar Nag", label:"Shri Pradeep Kumar Nag"},
{value:"Smt. Rajashree Pattanaik", label:"Smt. Rajashree Pattanaik"},
{value:"Shri Karunakar Bhue", label:"Shri Karunakar Bhue"},
{value:"Shri Biswojit Ghose", label:"Shri Biswojit Ghose"},
{value:"Shri Purna Ch. Bariha", label:"Shri Purna Ch. Bariha"},
{value:"Smt. Meenarani Mangal", label:"Smt. Meenarani Mangal"},
{value:"Shri LaxmanBhoi", label:"Shri LaxmanBhoi"},
{value:"Shri Amulya Kumar Pradhan", label:"Shri Amulya Kumar Pradhan"},
